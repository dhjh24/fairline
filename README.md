...
Bitcoin is a first-class board: hourly above/below contracts are fetched on their own (they never appear in Kalshi’s first event pages). Implied BTC is the strike where that ladder crosses 50¢.
